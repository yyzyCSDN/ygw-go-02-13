...
func (manager *Manager) Capture(reason string, values []model.Payment) Snapshot {
	manager.mu.Lock()
...
func (manager *Manager) Restore(id uint64) ([]model.Payment, error) {
...
func cloneValues(values []model.Payment) []model.Payment {
